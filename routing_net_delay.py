...
class MyTopo(Topo):
    ...
    def __init__(self):
        ...
        self.addLink(h1, s1, bw=1, delay='5ms', loss=0, max_queue_size=1000, use_htb=True)
        self.addLink(h2, s1, bw=1, delay='5ms', loss=0, max_queue_size=1000, use_htb=True)
        self.addLink(h3, s1, bw=1, delay='5ms', loss=0, max_queue_size=1000, use_htb=True)
        ...
        self.addLink(s5, h4, bw=1, delay='5ms', loss=0, max_queue_size=1000, use_htb=True)
        self.addLink(s5, h5, bw=1, delay='5ms', loss=0, max_queue_size=1000, use_htb=True)
        self.addLink(s5, h6, bw=1, delay='5ms', loss=0, max_queue_size=1000, use_htb=True)
